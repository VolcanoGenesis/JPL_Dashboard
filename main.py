...
def get_user_choices():
    ...
    return input_dir, output_dir, column_name, counter_choice, start_date, end_date
...
def main():
    input_dir, output_dir, column_name, counter_choice, start_date, end_date = get_user_choices()
